...
Phương thức HTTP GET có thể miêu tả ở Hình 2.
<p align="center">
  <img alt="HTTP GET" src="/tech-blog/assets/HTTPGET.png" style="zoom:50%">
  <br>
    <em>Hình 2. Phương thức HTTP GET</em>
</p>

Dựa theo Hình 2, chúng ta có thể viết yêu cầu theo phương thức HTTP GET trên NodeMCU theo dạng như sau:
